...
from strateobots.ai.evolution.lib import atan2, logical_or, binary_choice
...
class LongDistanceAttack(BaseAlgorithm):
    def _duel_control(self, bot, enemy):
        ...
        act_acceleration = (
            (1 - bot_should_fire) * (1 - has_some_shield) * should_retreat
        )
        act_fire = bot_should_fire
        act_idle = (1 - act_fire) * (1 - act_shield_warmup) * (1-act_acceleration)
